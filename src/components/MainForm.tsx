    ...
    <div className="container py-[40px] ">
      {!formType && (
        <div className="max-w-[800px] mx-auto">
          ...
          <button onClick={() => handleChoice("insurance")} className="text-left px-5 py-[10px] text-white bg-[#283C63] w-full rounded-md mb-2">
          Yes, let&apos;s check my insurance coverage <br/>
          Most insured people pay a copay of $25 or less
          </button>
          
          <button onClick={() => handleChoice("out-of-pocket")}className="text-left px-5 py-[10px] text-white bg-[#283C63] w-full rounded-md mb-2">
            I&apos;ll pay out-of-pocket <br/>
            Black Therapy Network is less expensive on average than in-person therapy
          </button>

          <button onClick={() => handleChoice("employer")} className="text-left px-5 py-[10px] text-white bg-[#283C63] w-full rounded-md mb-2">
